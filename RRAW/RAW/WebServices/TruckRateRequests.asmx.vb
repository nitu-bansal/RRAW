...
Namespace WebServices
    ...
    <ToolboxItem(False)> _
    Public Class TruckRateRequests
...
#Region "Masters"
        ...
        Public Function GetAllMasters(ByVal AuthenticationToken As String) As Dictionary(Of String, Object)
            ...
            res.Add("GetAllTruckShipMethods", GetAllShipMethods)
            res.Add("GetAllRegions", GetAllRegions)
            res.Add("GetAllTruckRatesValidFor", GetAllRatesValidFor)
            res.Add("GetAllWarehouseTypes", GetAllWarehouseTypes)
            res.Add("GetAllCustomClearanceModes", GetAllCustomClearanceModes)
            res.Add("GetAllTonnage", GetAllTonnage)
        ...
        Public Function GetAllShipMethods() As Dictionary(Of String, String)
            Dim cacheItemName As String = "ShipMethodsList"
            Dim tableName As String = "ShipMethods"

            Dim res As Dictionary(Of String, String) = GetCachedDictionaryItems(cacheItemName)
            If res Is Nothing Then
                res = DataTableToDictionary(DB.ShipMethods.GetAllShipMethods)
        ...
        Public Function GetAllRatesValidFor() As Dictionary(Of String, String)
            Dim cacheItemName As String = "TruckRatesValidForList"
            Dim tableName As String = "TruckRateValidFor"

            Dim res As Dictionary(Of String, String) = GetCachedDictionaryItems(cacheItemName)
            If res Is Nothing Then
                res = DataTableToDictionary(DB.Masters.GetAllTruckRatesValidFor)
        ...
        Public Function GetAllWarehouseTypes() As Dictionary(Of String, String)
            Dim cacheItemName As String = "WarehouseTypesList"
            Dim tableName As String = "TruckWarehouseType"

            Dim res As Dictionary(Of String, String) = GetCachedDictionaryItems(cacheItemName)
            If res Is Nothing Then
                res = DataTableToDictionary(DB.Masters.GetAllWarehouseTypes)
        ...
        Public Function GetAllCustomClearanceModes() As Dictionary(Of String, String)
            Dim cacheItemName As String = "CustomClearanceModesList"
            Dim tableName As String = "CustomClearanceModes"

            Dim res As Dictionary(Of String, String) = GetCachedDictionaryItems(cacheItemName)
            If res Is Nothing Then
                res = DataTableToDictionary(DB.CustomClearanceModes.GetAllCustomClearanceModes)
        ...
        Public Function GetAllTonnage() As Dictionary(Of String, String)
            Dim cacheItemName As String = "TonnageList"
            Dim tableName As String = "TruckRateTonnage"

            Dim res As Dictionary(Of String, String) = GetCachedDictionaryItems(cacheItemName)
            If res Is Nothing Then
                res = DataTableToDictionary(DB.Masters.GetAllTonnage)
...
#Region "Truck Rate Request Web Methods"
        <WebMethod()> _
        Public Function PostNewRateRequest(ByVal AuthenticationToken As String, ByVal RequestorID As Integer, ByVal ContainerNo As String, ByVal TruckHBL As String, ByVal ShipDate As Date, ByVal FreightTerm As String, ByVal WDShipMethod As String, ByVal ShipperName As String, ByVal OriginCity As String, ByVal OriginPort As String, ByVal OriginZipcode As String, ByVal OriginRegion As String, ByVal ConsigneeName As String, ByVal DestCity As String, ByVal DestPort As String, ByVal DestZipcode As String, ByVal DestRegion As String, ByVal RatesValidFor As String, ByVal RatesValidTill As Date, ByVal WarehouseType As String, ByVal CustomClearanceMode As String, ByVal Comment As String, ByVal Rates() As Object, ByVal Attachments() As Object) As Integer
            'Check for call authentication
            ...
            If PostNewRateRequest(NewRateRequestID, RequestorID, ContainerNo, TruckHBL, ShipDate, FreightTerm, WDShipMethod, ShipperName, OriginCity, OriginPort, OriginZipcode, OriginRegion, ConsigneeName, DestCity, DestPort, DestZipcode, DestRegion, RatesValidFor, RatesValidTill, WarehouseType, CustomClearanceMode, Comment) = errCode Then Return errCode
        ...
        <WebMethod()> _
        Public Function SaveNewRateRequest(ByVal AuthenticationToken As String, ByVal RequestorID As Integer, ByVal ContainerNo As String, ByVal TruckHBL As String, ByVal ShipDate As Date, ByVal FreightTerm As String, ByVal WDShipMethod As String, ByVal ShipperName As String, ByVal OriginCity As String, ByVal OriginPort As String, ByVal OriginZipcode As String, ByVal OriginRegion As String, ByVal ConsigneeName As String, ByVal DestCity As String, ByVal DestPort As String, ByVal DestZipcode As String, ByVal DestRegion As String, ByVal RatesValidFor As String, ByVal RatesValidTill As Date, ByVal WarehouseType As String, ByVal CustomClearanceMode As String, ByVal Comment As String, ByVal Rates() As Object, ByVal Attachments() As Object) As Integer
            'Check for call authentication
            If Not IsAuthenticated(AuthenticationToken) Then Return errCode
        ...
        <WebMethod()> _
        Public Function SaveExistingRateRequest(ByVal AuthenticationToken As String, ByVal RateRequestID As Integer, ByVal UserID As Integer, ByVal ContainerNo As String, ByVal TruckHBL As String, ByVal ShipDate As Date, ByVal FreightTerm As String, ByVal WDShipMethod As String, ByVal ShipperName As String, ByVal OriginCity As String, ByVal OriginPort As String, ByVal OriginZipcode As String, ByVal OriginRegion As String, ByVal ConsigneeName As String, ByVal DestCity As String, ByVal DestPort As String, ByVal DestZipcode As String, ByVal DestRegion As String, ByVal RatesValidFor As String, ByVal RatesValidTill As Date, ByVal WarehouseType As String, ByVal CustomClearanceMode As String, ByVal Comment As String, ByVal NewRates() As Object, ByVal UpdatedRates() As Object, ByVal RemovedRates As Object, ByVal Attachments() As Object) As Integer
            'Check for call authentication
            If Not IsAuthenticated(AuthenticationToken) Then Return errCode

            'Make sequence of function calls
            If UpdateRateRequest(RateRequestID, ContainerNo, TruckHBL, ShipDate, FreightTerm, WDShipMethod, ShipperName, OriginCity, OriginPort, OriginZipcode, OriginRegion, ConsigneeName, DestCity, DestPort, DestZipcode, DestRegion, RatesValidFor, RatesValidTill, WarehouseType, CustomClearanceMode, Comment) = errCode Then Return errCode
        ...
        <WebMethod()> _
        Public Function ApproveRateRequest(ByVal AuthenticationToken As String, ByVal RateRequestID As Integer, ByVal ApproverID As Integer, ByVal ContainerNo As String, ByVal TruckHBL As String, ByVal ShipDate As Date, ByVal FreightTerm As String, ByVal WDShipMethod As String, ByVal ShipperName As String, ByVal OriginCity As String, ByVal OriginPort As String, ByVal OriginZipcode As String, ByVal OriginRegion As String, ByVal ConsigneeName As String, ByVal DestCity As String, ByVal DestPort As String, ByVal DestZipcode As String, ByVal DestRegion As String, ByVal RatesValidFor As String, ByVal RatesValidTill As Date, ByVal WarehouseType As String, ByVal CustomClearanceMode As String, ByVal Comment As String, ByVal NewRates() As Object, ByVal UpdatedRates() As Object, ByVal RemovedRates As Object, ByVal Attachments() As Object) As Integer
            'Check for call authentication
            If Not IsAuthenticated(AuthenticationToken) Then Return errCode
        ...
        <WebMethod()> _
        Public Function SendRateRequestBackToRevise(ByVal AuthenticationToken As String, ByVal RateRequestID As Integer, ByVal RejectorID As Integer, ByVal ContainerNo As String, ByVal TruckHBL As String, ByVal ShipDate As Date, ByVal FreightTerm As String, ByVal WDShipMethod As String, ByVal ShipperName As String, ByVal OriginCity As String, ByVal OriginPort As String, ByVal OriginZipcode As String, ByVal OriginRegion As String, ByVal ConsigneeName As String, ByVal DestCity As String, ByVal DestPort As String, ByVal DestZipcode As String, ByVal DestRegion As String, ByVal RatesValidFor As String, ByVal RatesValidTill As Date, ByVal WarehouseType As String, ByVal CustomClearanceMode As String, ByVal Comment As String, ByVal NewRates() As Object, ByVal UpdatedRates() As Object, ByVal RemovedRates As Object, ByVal Attachments() As Object) As Integer
            'Check for call authentication
            If Not IsAuthenticated(AuthenticationToken) Then Return errCode
        ...
        Public Function RevokeRateRequest(ByVal AuthenticationToken As String, ByVal RateRequestID As Integer, ByVal RevokerID As Integer, ByVal Comment As String) As Integer
            ...
            Dim Requestor = DB.Users.GetDetails(CInt(DB.TruckRateRequests.GetRateRequest(RateRequestID).Rows(0)("RequestorID")))
        ...
        Public Function ArchiveRateRequest(ByVal AuthenticationToken As String, ByVal RateRequestID As Integer, ByVal ArchiverID As Integer, ByVal Comment As String) As Integer
            ...
            Dim Requestor As DataRow = DB.Users.GetDetails(CInt(DB.TruckRateRequests.GetRateRequest(RateRequestID).Rows(0)("RequestorID")))
        ...
        Public Function GetRateRequest(ByVal AuthenticationToken As String, ByVal RateRequestID As Integer) As Dictionary(Of String, Object)
            ...
            'Make sequence of function calls
            Dim RateRequest = DB.TruckRateRequests.GetRateRequest(RateRequestID)
            ...
            Dim Rates = DataTableToComplexDictionary(DB.TruckRates.GetRates(RateRequestID))
            res.Add("Rates", Rates)
        ...
        '    Dim res As New Dictionary(Of String, Object)
        '    res.Add("Masters", (New WebServices.Masters).GetAllTruckMasters(AuthenticationToken))
...
#Region "Truck Rate Request Background Operations"
        Private Function PostNewComment(ByVal RateRequestID As Integer, ByVal UserID As Integer, ByVal Comment As String) As Integer
            ...
            If Comment.Trim() <> "" Then
                ...
                Return DB.TruckRateRequests.PostNewComment(RateRequestID, UserID, Comment)
            Else
                Return 0
            End If
        End Function
        ...
        Private Function RemoveAllComments(ByVal RateRequestID As Integer) As Integer
            ...
            'Call BLL function if valid
            Return DB.TruckRateRequests.RemoveAllComments(RateRequestID)
        End Function
        ...
        Private Function PostNewRateRequest(ByVal RateRequestID As Integer, ByVal RequestorID As Integer, ByVal ContainerNo As String, ByVal TruckHBL As String, ByVal ShipDate As Date, ByVal FreightTerm As String, ByVal WDShipMethod As String, ByVal ShipperName As String, ByVal OriginCity As String, ByVal OriginPort As String, ByVal OriginZipcode As String, ByVal OriginRegion As String, ByVal ConsigneeName As String, ByVal DestCity As String, ByVal DestPort As String, ByVal DestZipcode As String, ByVal DestRegion As String, ByVal RatesValidFor As String, ByVal RatesValidTill As Date, ByVal WarehouseType As String, ByVal CustomClearanceMode As String, ByVal Comment As String) As Integer
            ...
            If IsValid(TruckHBL) = False Then Return errCode
            If IsValid(ShipDate) = False Then Return errCode
            If IsValid(FreightTerm) = False Then Return errCode
            If IsValid(WDShipMethod) = False Then Return errCode
            If IsValid(ShipperName) = False Then Return errCode
            If IsValid(OriginCity) = False Then Return errCode
            If IsValid(OriginPort) = False Then Return errCode
            If IsValid(OriginZipcode) = False Then Return errCode
            If IsValid(OriginRegion) = False Then Return errCode
            If IsValid(ConsigneeName) = False Then Return errCode
            If IsValid(DestCity) = False Then Return errCode
            If IsValid(DestPort) = False Then Return errCode
            If IsValid(DestZipcode) = False Then Return errCode
            If IsValid(DestRegion) = False Then Return errCode
            If IsValid(RatesValidFor) = False Then Return errCode
            If IsValid(RatesValidTill) = False Then Return errCode

            'Call BLL function if valid
            Return DB.TruckRateRequests.PostNewRateRequest(RateRequestID, RequestorID, ContainerNo, TruckHBL, ShipDate, FreightTerm, WDShipMethod, ShipperName, OriginCity, OriginPort, OriginZipcode, OriginRegion, ConsigneeName, DestCity, DestPort, DestZipcode, DestRegion, RatesValidFor, RatesValidTill, WarehouseType, CustomClearanceMode, Comment)
        End Function
        ...
        Private Function ApproveRateRequestByClient(ByVal RateRequestID As Integer, ByVal ApproverID As Integer) As Integer
            ...
            'Call BLL function if valid
            Return DB.TruckRateRequests.ApproveRateRequestByClient(RateRequestID, ApproverID)
        End Function
        ...
        Private Function RejectRateRequest(ByVal RateRequestID As Integer, ByVal RejectorID As Integer) As Integer
            ...
            'Call BLL function if valid
            Return DB.TruckRateRequests.RejectRateRequest(RateRequestID, RejectorID)
        End Function
        ...
        Private Function RevokeRateRequest(ByVal RateRequestID As Integer, ByVal RevokerID As Integer) As Integer
            ...
            'Call BLL function if valid
            Return DB.TruckRateRequests.RevokeRateRequest(RateRequestID, RevokerID)
        End Function
        ...
        Private Function ArchiveRateRequest(ByVal RateRequestID As Integer, ByVal ArchiverID As Integer) As Integer
            ...
            'Call BLL function if valid
            Return DB.TruckRateRequests.ArchiveRateRequest(RateRequestID, ArchiverID)
        End Function

        Private Function UpdateRateRequest(ByVal RateRequestID As Integer, ByVal ContainerNo As String, ByVal TruckHBL As String, ByVal ShipDate As Date, ByVal FreightTerm As String, ByVal WDShipMethod As String, ByVal ShipperName As String, ByVal OriginCity As String, ByVal OriginPort As String, ByVal OriginZipcode As String, ByVal OriginRegion As String, ByVal ConsigneeName As String, ByVal DestCity As String, ByVal DestPort As String, ByVal DestZipcode As String, ByVal DestRegion As String, ByVal RatesValidFor As String, ByVal RatesValidTill As Date, ByVal WarehouseType As String, ByVal CustomClearanceMode As String, ByVal Comment As String) As Integer
            'Refine and validate input values
            If IsValid(RateRequestID) = False Then Return errCode
            If IsValid(ContainerNo) = False Then Return errCode
            If IsValid(TruckHBL) = False Then Return errCode
            ...
            'Call BLL function if valid
            Return DB.TruckRateRequests.UpdateRateRequest(RateRequestID, ContainerNo, TruckHBL, ShipDate, FreightTerm, WDShipMethod, ShipperName, OriginCity, OriginPort, OriginZipcode, OriginRegion, ConsigneeName, DestCity, DestPort, DestZipcode, DestRegion, RatesValidFor, RatesValidTill, WarehouseType, CustomClearanceMode, Comment)
        End Function
        ...
        Private Function PostNewRates(ByVal RateRequestID As Integer, ByVal ParamRates() As Object) As Integer
            ...
            For Each RateRow As Array In Rates
                ...
                If RateRow IsNot Nothing Then
                    Dim RateTitle As String = CStr(RateRow.GetValue(0))
                    Dim Tonnage As String = CStr(RateRow.GetValue(1))
                    Dim LTLPerCBM As Double = CDbl(IIf(RateRow.GetValue(2).ToString <> "", RateRow.GetValue(2), 0))
                    Dim LTLMin As Double = CDbl(IIf(RateRow.GetValue(3).ToString <> "", RateRow.GetValue(3), 0))
                    Dim FTL As Double = CDbl(IIf(RateRow.GetValue(4).ToString <> "", RateRow.GetValue(4), 0))

                    'Call BLL function if valid
                    If DB.TruckRates.PostNewRates(RateRequestID, RateTitle, Tonnage, LTLPerCBM, LTLMin, FTL) = errCode Then Return errCode
                End If
            Next
        ...
        Private Function UpdateRates(ByVal ParamRates() As Object) As Integer
            ...
            For Each RateRow As Array In Rates
                ...
                Dim RateTitle As String = CStr(RateRow.GetValue(1))
                Dim Tonnage As String = CStr(RateRow.GetValue(2))
                Dim LTLPerCBM As Double = CDbl(IIf(RateRow.GetValue(3).ToString <> "", RateRow.GetValue(3), 0))
                Dim LTLMin As Double = CDbl(IIf(RateRow.GetValue(4).ToString <> "", RateRow.GetValue(4), 0))
                Dim FTL As Double = CDbl(IIf(RateRow.GetValue(5).ToString <> "", RateRow.GetValue(5), 0))

                'Call BLL function if valid
                If DB.TruckRates.UpdateRates(RateID, RateTitle, Tonnage, LTLPerCBM, LTLMin, FTL) = errCode Then Return errCode
            Next
        ...
        Private Function RemoveRates(ByVal ParamRateIDs As Object) As Integer
            ...
            For Each RateID As Integer In RateIDs
                'Call BLL function if valid
                If DB.TruckRates.RemoveRates(RateID) = errCode Then Return errCode
            Next
        ...
        Private Function ClearRejectedTag(ByVal RateRequestID As Integer) As Integer
            ...
            'Call BLL function if valid
            Return DB.TruckRateRequests.ClearRejectedTag(RateRequestID)
        End Function
        ...
        Private Function SendApprovalMail(ByVal Receiver As DataRow, ByVal SenderID As Integer, ByVal RateRequestID As Integer) As Integer
            ...
            'Call BLL function if valid
            If SendMail(Receiver("Email").ToString, "Hi " & Receiver("Name").ToString & ", A Rate request has been approved by " & Sender("Name").ToString, "Find rate request details at http://rraw.invoize.com/Master.aspx?ChildPage=TruckRateRequest.aspx?RateRequestID=" & RateRequestID & ".") = False Then Return errCode
        End Function
        ...
        Private Function SendRevisionMail(ByVal Receiver As DataRow, ByVal SenderID As Integer, ByVal RateRequestID As Integer) As Integer
            ...
            If SendMail(Receiver("Email").ToString, "Hi " & Receiver("Name").ToString & ", A Rate request has been sent back to revise by " & Sender("Name").ToString, "Find rate request details at http://rraw.invoize.com/Master.aspx?ChildPage=TruckRateRequest.aspx?RateRequestID=" & RateRequestID & ".") = False Then Return errCode
        End Function
        ...
        Private Function SendRejectionMail(ByVal Receivers As DataTable, ByVal SenderID As Integer, ByVal RateRequestID As Integer) As Integer
            ...
            For Each Receiver As DataRow In Receivers.Rows
                If SendMail(Receiver("Email").ToString, "Hi " & Receiver("Name").ToString & ", A Rate request has been rejected by " & Sender("Name").ToString, "Find rate request details at http://rraw.invoize.com/Master.aspx?ChildPage=TruckRateRequest.aspx?RateRequestID=" & RateRequestID & ".") = False Then Return errCode
            Next
        End Function
        ...
        Private Function SendRevokeMail(ByVal Receivers As DataTable, ByVal SenderID As Integer, ByVal RateRequestID As Integer) As Integer
            ...
            For Each Receiver As DataRow In Receivers.Rows
                If SendMail(Receiver("Email").ToString, "Hi " & Receiver("Name").ToString & ", A Rate request has been pulled back by " & Sender("Name").ToString, "Find rate request details at http://rraw.invoize.com/Master.aspx?ChildPage=TruckRateRequest.aspx?RateRequestID=" & RateRequestID & ".") = False Then Return errCode
            Next
        End Function
        ...
        Private Function SendArchiveMail(ByVal Receivers As DataTable, ByVal SenderID As Integer, ByVal RateRequestID As Integer) As Integer
            ...
            For Each Receiver As DataRow In Receivers.Rows
                If SendMail(Receiver("Email").ToString, "Hi " & Receiver("Name").ToString & ", A Rate request has been archived by " & Sender("Name").ToString, "Find rate request details at http://rraw.invoize.com/Master.aspx?ChildPage=TruckRateRequest.aspx?RateRequestID=" & RateRequestID & ".") = False Then Return errCode
            Next
        End Function
        ...
        Private Function SendCommentRemovalMail(ByVal Receivers As DataTable, ByVal SenderID As Integer, ByVal RateRequestID As Integer) As Integer
            ...
            For Each Receiver As DataRow In Receivers.Rows
                If SendMail(Receiver("Email").ToString, "Hi " & Receiver("Name").ToString & ", All comments has been removed from a Rate request by " & Sender("Name").ToString, "Find rate request details at http://rraw.invoize.com/Master.aspx?ChildPage=TruckRateRequest.aspx?RateRequestID=" & RateRequestID & ".") = False Then Return errCode
            Next
        End Function
        ...
        Private Function SendMailToRelatedUsers(ByVal RateRequestID As Integer, ByVal CurrentUserID As Integer) As Integer
            ...
            For Each dr1 As DataRow In DB.Users.GetRelatedUsers(RateRequestID, CurrentUserID).Rows
                If SendMail(dr1("Email").ToString, "Hi " & dr1("Name").ToString & ", A rate request has been approved by " & Sender("Name").ToString, "Find rate request details at http://rraw.invoize.com/Master.aspx?ChildPage=TruckRateRequest.aspx?RateRequestID=" & RateRequestID & "." & vbNewLine & "Rate Request will get transferred to Tariff within 24 hours.") = False Then Return errCode
            Next

            'Send mail to request generator
            Dim dr2 As DataRow = DB.Users.GetDetails(CInt(DB.TruckRateRequests.GetRateRequest(RateRequestID).Rows(0)("RequestorID")))
            If SendMail(dr2("Email").ToString, "Hi " & dr2("Name").ToString & ", Your rate request has been approved by " & Sender("Name").ToString, "Find rate request details at http://rraw.invoize.com/Master.aspx?ChildPage=TruckRateRequest.aspx?RateRequestID=" & RateRequestID & "." & vbNewLine & "Rate Request will get transferred to Tariff within 24 hours.") = False Then Return errCode
