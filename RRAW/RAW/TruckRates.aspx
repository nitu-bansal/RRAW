<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TruckRates.aspx.vb" Inherits="RRAW.TruckRates" %>
...
<body onload="try{locateonload(this.offsetTop)}catch(e){};try{top.document.getElementById('processing_image').style.display='none'}catch(e){};">
    ...
    <div style="position: fixed; text-align: center; text-decoration: underline; width: 100%;" >
        <br />
        <span class="ui-accordion-header ui-helper-reset ui-state-default ui-state-active" id="lblTitle" style="text-decoration: underline; font-size: small; font-weight: 700;">
            Ground Tariff Effectives</span>
    </div>
    <br />
    <br />
    <br />
    <%--<div id="div1" style="width: 100%">
        <table style="text-align: center; position: relative; width: 2045; box-shadow: 0 2px 2px -1px rgba(0, 0, 0, .2);
    ...
    function addReflections() {
        ...
        $('#<%=gridTariff.ClientID %>').dataTable({
            ...
            "oTableTools": {
                ...
                "aButtons": ["copy", {
                    "sExtends": "csv",
                    "sFileName": "Tariff_Ground.csv",
                    "bFooter": false
                },
                                    {
                                        "sExtends": "xls",
                                        "sFileName": "Tariff_Ground.xls",
                                        "bFooter": false
                                    }]
            }
