...
<body onload="function f(){var t=new Date();return((t.getMonth()+1)+'/'+t.getDate()+'/'+t.getFullYear()+' '+t.getHours()+':'+t.getMinutes()+':'+t.getSeconds())};document.getElementById('hidCurrentDateTime').value=f();">
    <div class="outerpart">
        ...
        <div class="ui-widget-header ui-state-active  bluebar"  style="height: 25px;">
            <div id="TARIFFSEARCH" style="display:none;" class="divTariffSearch" >
               <a class="mixin" href="TariffSearch.aspx" target="main" title="Search"
                        id="A1" onclick="ShowHideClient('tariffsearchlink');locate(this.offsetTop, 'rateslink', this.id);" >    
                        
                        <div style="float:right;"><img  width="20px" height="20px" alt="Search" src="Images/Search.png" /> </div> 
                        <div style="float:right;padding-right:2px; color:#000000;">Search for Tariff</div>                                             
                        </a>
             </div>
        </div>
                                            ...
                                            <li id="rates" style="display: none">
                                                ...
                                                <ul>
                                                    <li id="TARIFF_NEW" class="sub-menu" style="display: none">
                                                     ...
                                                     <%--<li id="TARIFFSEARCH" class="sub-menu" style="display: none">
                                                        <div class="menu-item">
                                                            <a class="mixin" href="TariffSearch.aspx" target="main" title="Search"
                                                                id="tariffsearchlink" onclick="ShowHideClient('tariffsearchlink');locate(this.offsetTop, 'rateslink', this.id);">
                                                                Search</a></div>
                                                    </li>--%>
