<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="OceanRateRequest_OLD.aspx.vb"
    Inherits="RRAW.OceanRateRequest_OLD" %>
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="gridUpdates" runat="server"
                                        ...
                                        <EmptyDataTemplate>
                                            No Ocean Rate Request Template files available.<br />
                                            <br />
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" SelectCommand="GetAttachments"
                                        ...
                                        <SelectParameters>
                                            <asp:Parameter DefaultValue="OceanRateRequestTemplate" Name="AttachmentType" />
                                        </SelectParameters>
                                    </asp:SqlDataSource>
                                </td>
                            </tr>
                                ...
                                <td align="left">
                                    <table style="width: 100%;">
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <br />
                                                Status:&nbsp;<asp:Label ID="lblStatus" runat="server" Text="Browse for latest Ocean Rate Request Template file and upload"></asp:Label>
