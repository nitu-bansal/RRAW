Partial Public Class TruckRates
    ...
    Private Sub ApplyFilter()
        ...
        DT_Tariff = DB.Tariffs_New.GetTariffFromDB(3, CurrentClientID, 0)
    ...
    '    ExportFile(DT_ExportTariff, "CSV", "GroundTariff")
    'End Sub
    ...
    '    ExportFile(DT_ExportTariff, "Excel", "GroundTariff")
    'End Sub
    ...
    Private Sub gridTariff_DataBound(ByVal sender As Object, ByVal e As System.EventArgs) Handles gridTariff.DataBound
        ...
        For i As Integer = 0 To gridTariff.Rows.Count - 1
            gridTariff.Rows(i).Cells(0).Text = "<a href='newGroundRateRequest.aspx?RateRequestID=" & gridTariff.Rows(i).Cells(0).Text & "&TransPortModeId=3&rand=" & (New Random).Next(9999) & "'>" & gridTariff.Rows(i).Cells(0).Text & "</a>"
        Next
