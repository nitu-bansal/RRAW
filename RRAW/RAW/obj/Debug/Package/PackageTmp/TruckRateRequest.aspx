<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TruckRateRequest.aspx.vb"
    Inherits="RRAW.TruckRateRequest" %>
                ...
                <tr>
                    <td style="width: 50%;vertical-align:top">
                        <table style="width: 100%;" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="gridUpdates" runat="server"
                                        ...
                                        <EmptyDataTemplate>
                                            No Truck Rate Request Template files available.<br />
                                            <br />
                                            You can upload from the &quot;New Template&quot; panel available in right.
                                        </EmptyDataTemplate>
                                        <HeaderStyle BackColor="#336699" Font-Bold="True" ForeColor="White" />
                                        <PagerSettings Mode="NextPreviousFirstLast" FirstPageText="First" LastPageText="Last"
                                            NextPageText="Next" PreviousPageText="Previous" />
                                        <PagerStyle BackColor="#336699" ForeColor="White" HorizontalAlign="Center" CssClass="FixedPosition"
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" SelectCommand="GetAttachments"
                                        ...
                                        <SelectParameters>
                                            <asp:Parameter DefaultValue="TruckRateRequestTemplate" Name="AttachmentType" />
                                        </SelectParameters>
                                    </asp:SqlDataSource>
                                </td>
                            </tr>
                    ...
                    <td style="width: 50%">
                        <table runat="server" id="tblTruckUpload" visible="false" style="width: 100%;" cellspacing="0"
                            cellpadding="0">
                            <tr>
                                <td>
                                    <span style="font-weight: 700; text-decoration: underline;">New Template</span><hr />
                                </td>
                            </tr>
                            <tr>
                                <td align="left">
                                    <table style="width: 100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Button ID="btnUpdateOcean" runat="server" Text="Update" 
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <br />
                                                Status:&nbsp;<asp:Label ID="lblStatus" runat="server" Text="Browse for latest Truck Rate Request Template file and upload"></asp:Label>
