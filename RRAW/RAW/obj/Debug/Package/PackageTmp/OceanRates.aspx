<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="OceanRates.aspx.vb" Inherits="RRAW.OceanRates" %>
...
<body onload="try{top.document.getElementById('processing_image').style.display='none'}catch(e){};function f(){var t=new Date();return((t.getMonth()+1)+'/'+t.getDate()+'/'+t.getFullYear()+' '+t.getHours()+':'+t.getMinutes()+':'+t.getSeconds())};document.getElementById('hidCurrentDateTime').value=f();">
    ...
    <div>
        <center>
            ...
            <span style="text-decoration: underline; font-size: small; font-weight: 700">Ocean
                Rates</span>
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="gridUpdates" runat="server" AllowPaging="True" AllowSorting="True"
                                        ...
                                        <EmptyDataTemplate>
                                            No Ocean Rate files available.<br />
                                            <br />
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" SelectCommand="GetAttachments"
                                        ...
                                        <SelectParameters>
                                            <asp:Parameter DefaultValue="OceanRates" Name="AttachmentType" />
                                        </SelectParameters>
                                    </asp:SqlDataSource>
                                </td>
                            </tr>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                ...
                                                Status:&nbsp;<asp:Label 
                                                    ...
                                                    Text="Browse for latest Ocean Rate Update file and upload"></asp:Label>
...
<script src="Scripts/OceanRates.min.js" type="text/javascript"></script>
</html>
