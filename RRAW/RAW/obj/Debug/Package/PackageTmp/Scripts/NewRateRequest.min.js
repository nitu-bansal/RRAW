...
//var ApplyValidation=(new Date())>= (new Date("April 13, 2012 23:59:59"))?true:false;
...
function btnSendBackToRequestor_onClick() {
    if (Page_ClientValidate() == false) return false;

    DisplayProgress('Sending rate request back to Requestor...', 'Rate request reverting back...');
}
