...
<body onload="onLoad()">
    ...
    <div>
        ...
        <div id="divReports">
            ...
            <br />
            <br />
            <div id="divAIRNewLanesAddedInMonth">
                <a id="linkAIRNewLanesAddedInMonth" href="#" onclick="return NewLanesAddedInMonth(document.getElementById('selectMonth').selectedIndex + 1, true,'AIR')">
                    Generate & Download Report for <span style="font-weight: 700">New Lanes Added in AIR in <span
                        id="selectedNewLanesAddedInMonthMonthNameAIR"></span></span></a>
            </div>

            <br />
            <br />
            <div id="divOCEANNewLanesAddedInMonth">
                <a id="linkOCEANNewLanesAddedInMonth" href="#" onclick="return NewLanesAddedInMonth(document.getElementById('selectMonth').selectedIndex + 1, true,'OCEAN')">
                    Generate & Download Report for <span style="font-weight: 700">New Lanes Added in OCEAN in <span
                        id="selectedNewLanesAddedInMonthMonthNameOCEAN"></span></span></a>
            </div>
            ...
            <br />
            <br />
            <div id="divAIRMonthlyRequestFrequency">
                <a id="linkAIRMonthlyRequestFrequency" href="#" onclick="return MonthlyRequestFrequency(true,'AIR')">
                    Generate & Download Report for <span style="font-weight: 700">Origin - Destination Monthly
                        Request Frequency(AIR)</span></a>
            </div>

            <br />
            <br />
            <div id="divOCEANMonthlyRequestFrequency">
                <a id="linkOCEANRMonthlyRequestFrequency" href="#" onclick="return MonthlyRequestFrequency(true,'OCEAN')">
                    Generate & Download Report for <span style="font-weight: 700">Origin - Destination Monthly
                        Request Frequency(OCEAN)</span></a>
            </div>
        </div>
    </div>
    </form>
