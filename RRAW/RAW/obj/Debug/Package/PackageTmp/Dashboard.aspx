...
<body onload="try{locate(this.offsetTop,'dashboardlink')}catch(e){};try{top.document.getElementById('processing_image').style.display='none'}catch(e){};">
    ...
    <div class=" ui-widget-content">
        ...
        <asp:HiddenField ID="hidEffectiveDate" runat="server" />
        ...
        <div class="page_title ui-accordion-header ui-helper-reset ui-state-default ui-state-active"
        style="height: 23px">
            Dashboard</div>
        <%--<asp:Label ID="hidCallback" runat="server" EnableViewState="False" onchange="document.getElementById('UpdateProgress1').style.display='none'" Visible="False"></asp:Label>--%>
        <asp:Label ID="hidCallback" runat="server" EnableViewState="False" Visible="False"></asp:Label>
        <table style="width: 100%">
            <tr>
                <td align="left">                
                    Display data as from<asp:TextBox ID="txtPeriodFrom" runat="server" BorderWidth="0"
                        BorderStyle="None" Font-Bold="True" CssClass="CenterAlign" Width="82px"
                    ...
                    to<asp:TextBox ID="txtPeriodTo" runat="server" BorderWidth="0" BorderStyle="None"
                        ...
                        Font-Bold="True" CssClass="CenterAlign" Width="82px" ForeColor="#507CD1"
            ...
            <tr style="vertical-align:top;"><td ><hr /></td></tr>
        </table>
                                    ...
                                    <%--<asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                            ...
                                            <table style="width: 100%;" cellspacing="0" cellpadding="4">
                                                <tr style="  background-color: #336699">
                                                    ...
                                                    <td style="min-width: 10px; border-style: none" align="center">
                                                        <asp:LinkButton ID="linkInDiscussionStationRequests" Style="color: #fff" runat="server"
                                                            Font-Bold="true" ToolTip="Click here to see In Discussion (CEVA) requests"
                                                            EnableViewState="False">In_Discussion (CEVA)</asp:LinkButton>
                                                    </td>
                                                    <td style="min-width: 10px; border-style: none" align="center">
                                                        <asp:LinkButton ID="linkInDiscussionClientRequests" Style="color: #fff" runat="server"
                                                            Font-Bold="true" ToolTip="Click here to see In Discussion (WD) requests" EnableViewState="False" Text=""></asp:LinkButton>
                                                    </td>
                                                ...
                                                <tr style="background-color: #EFF3FB;">
                                                    ...
                                                    <td align="right" style="min-width: 5px; padding-right: 3px; border-right-style: none">
                                                        <asp:Label ID="lblInDiscussionStationRequests" runat="server" Text="0"></asp:Label>
                                                    </td>
                                                    <td align="right" style="min-width: 5px; padding-right: 3px; border-right-style: none">
                                       ...
                                       <%-- </ContentTemplate>
                                        <Triggers>
                                            ...
                                            <asp:AsyncPostBackTrigger ControlID="cmbClients" EventName="SelectedIndexChanged" />
                                        </Triggers>
                                    </asp:UpdatePanel>--%>
                                </td>
                            </tr>
                                        ...
                                        <ContentTemplate>--%>
                                            <table style="width: 100%;" cellspacing="0" cellpadding="4">
                                                <tr style="  background-color: #336699">
                                                    ...
                                                    <td style="min-width: 10px; border-style: none" align="center">
                                                        <asp:LinkButton ID="linkInDiscussionInLoopStationRequests" Style="color: #fff" runat="server"
                                                            Font-Bold="true" ToolTip="Click here to see In Discussion (CEVA) requests"
                                                            EnableViewState="False">In_Discussion (CEVA)</asp:LinkButton>
                                                    </td>
                                                    <td style="min-width: 10px; border-style: none" align="center">
                                                        <asp:LinkButton ID="linkInDiscussionInLoopClientRequests" Style="color: #fff" runat="server"
                                                            Font-Bold="true"  EnableViewState="False" Text=""></asp:LinkButton>
                                                    </td>
                                                    <td align="center" style="min-width: 10px; border-style: none">
                                                ...
                                                <tr style="background-color: #EFF3FB;">
                                                    ...
                                                    <td align="right" style="min-width: 5px; padding-right: 3px; border-right-style: none">
                                                        <asp:Label ID="lblInDiscussionInLoopStationRequests" runat="server" Text="0"></asp:Label>
                                                    </td>
                                                    <td align="right" style="min-width: 5px; padding-right: 3px; border-right-style: none">
                                    ...
                                    <tr>
                                        <td style="border-style: none;">
                                            ...
                                            <asp:GridView ID="gridRateRequestGroupings" runat="server" AllowPaging="True" AllowSorting="True"
                                                ...
                                                <Columns>                                                    
                                                    <asp:BoundField DataField="Open" HeaderText="New Request" ReadOnly="True" SortExpression="Open" />
                                                    <asp:BoundField DataField="In_Discussion_Station" HeaderText="In_Discussion (CEVA)"
                                                        ReadOnly="True" SortExpression="In_Discussion (Station)" />
                                                    <asp:BoundField DataField="In_Discussion_Client" HeaderText="In_Discussion (Client)" ReadOnly="True"
                                                        SortExpression="In_Discussion (Client)" />
                                                ...
                                                <FooterStyle BackColor="#336699" CssClass="no-border" Font-Bold="True" ForeColor="White"
                                                    Height="15px" VerticalAlign="Bottom" />
                                                <HeaderStyle BackColor="#336699" BorderColor="Gray" BorderStyle="Solid" BorderWidth="1px"
                                                    CssClass="with-border" Font-Bold="True" ForeColor="White" />
                                                <PagerSettings FirstPageText="First" LastPageText="Last" Mode="NumericFirstLast"
                                                    NextPageText="Next" PreviousPageText="Previous" />
                                                <PagerStyle BackColor="#336699" CssClass="no-border" Font-Bold="False" Font-Size="Larger"
                    ...
                    <td>
                       <%-- <asp:UpdatePanel ID="UpdatePanel1" runat="server" EnableViewState="False">
                                            ...
                                            <div>
                                                <asp:GridView ID="gridRateRequests" runat="server" AllowPaging="True" AllowSorting="True"
                                                    ...
                                                    <PagerSettings FirstPageText="First" LastPageText="Last" Mode="NextPreviousFirstLast"
                                                        NextPageText="Next" PreviousPageText="Previous" />
                                                    <PagerStyle BackColor="#336699" CssClass="no-border" Font-Size="Larger" ForeColor="White"
                            ...
                            <Triggers>
                                ...
                                <asp:AsyncPostBackTrigger ControlID="linkInDiscussionStationRequests" EventName="Click" />
