...
<body onload="try{locate(this.offsetTop, 'rateslink','tarifflink')}catch(e){};try{top.document.getElementById('processing_image').style.display='none'}catch(e){};javascript:document.getElementById('txtCustomer').focus();">
            ...
            <ContentTemplate>
                ...
                <asp:GridView ID="gridTariff" runat="server" AllowPaging="True" AllowSorting="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Destination  State          If Applicable" HeaderText="Dest State" SortExpression="Destination  State          If Applicable" />
                        ...
                        <asp:BoundField DataField="Destination Postal (ZIP) Code" HeaderText="Dest Zipcode" SortExpression="Destination Postal (ZIP) Code" />
                        ...
                        <asp:BoundField DataField="Forwarder Delivery City or Postal Code" HeaderText="Forwarder Zipcode" SortExpression="Forwarder Delivery City or Postal Code" />
                        ...
                        <asp:BoundField DataField="USD Valid Int'l Per Kilo Rate Effective January 1 #### (Current Year)" HeaderText="Freight Rate" ReadOnly="True"
                            SortExpression="USD Valid Int'l Per Kilo Rate Effective January 1 #### (Current Year)">
                            <HeaderStyle Width="100px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="USD Security Charge Effective January 1 #### (Current Year)" HeaderText="Security Rate" ReadOnly="True"
                            SortExpression="USD Security Charge Effective January 1 #### (Current Year)">
                            <HeaderStyle Width="100px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="Other Charges" HeaderText="Other Charges" ReadOnly="True"
                            SortExpression="Other Charges" />
