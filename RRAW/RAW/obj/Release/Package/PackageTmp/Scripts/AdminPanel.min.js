...
function FillModules() {
    ...
    $.each(modules, function (key, val) {
        if (i == 0) {
            $("#divModules").append("<div style='border:1px solid #DAE3F6;background-color:#EFF3FB'><br /><input type='checkbox' id='chk_" + val.toString().split(',')[0] + "' /><span id='lbl_" + val.toString().split(',')[0] + "'>" + val.toString().split(',')[1] + "</span></div>");
            i = 1;
        }
        else {
            $("#divModules").append("<div style='border:1px solid #DAE3F6'><br /><input type='checkbox' id='chk_" + val.toString().split(',')[0] + "' /><span id='lbl_" + val.toString().split(',')[0] + "'>" + val.toString().split(',')[1] + "</span></div>");
            i = 0;
        }
    });
}
