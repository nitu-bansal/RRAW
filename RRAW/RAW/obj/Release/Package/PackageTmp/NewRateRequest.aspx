            ...
            <tr>
                                    ...
                                    <table cellpadding="0" cellspacing="0" class="tbl">
                                        ...
                                        <tr>
                                            <td style="text-align: center">
                                                ...
                                                <asp:Button ID="btnApprove" runat="server" OnClientClick="btnApprove_onClick();"
                                                    Text="Approve" Visible="false" EnableViewState="False" />
                                                <asp:Button ID="btnApproveAsAdhoc" runat="server" Text="Approve As Adhoc" OnClientClick="btnApproveAsAdhoc_onClick();"
                                                ...
                                                <asp:Button ID="btnSendBackToReviseRate" runat="server" Text="Send Back To Revise Rate"
                                                    Visible="False" OnClientClick="btnSendBackToReviseRate_onClick();" EnableViewState="False" />
                                                <asp:Button ID="btnReject" runat="server" OnClientClick="btnReject_onClick();" Text="Reject"
                                                    Visible="False" EnableViewState="False" />
                                                ...
                                                <asp:Button ID="btnRemoveAllComments" runat="server" Text="Remove All Comments" Visible="False"
                                                    OnClientClick="btnRemoveAllComments_onClick();" EnableViewState="False" /><br />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                ...
                <td>
                    <asp:Panel runat="server" ID="pnlCapture" EnableViewState="false">
                        Paste data from FMS & OFS here to capture<br />
                        ...
                        <center>
                            <input id="btnCapture"type="button"value="Capture"
                                onclick="getData('txtCapture');"/></center>
                    </asp:Panel>
