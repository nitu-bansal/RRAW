Partial Public Class OceanRates
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        For Each row As DataRow In DB.UserModulesMapping.GetAccesibleModulesOfUser(CurrentUserID, CurrentClientID).Rows
            If row("Name").ToString.Trim = "oceanratesremove" Then
    ...
    Protected Sub btnUploadOcean_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnUploadOcean.Click
        Try
            ...
            If Page.IsValid Then
                ...
                DB.Attachments.AddAttachment(DB.Attachments.AttachmentTypes.OceanRates, 0, txtTitle.Text, filePath)

                txtTitle.Text = ""
                gridUpdates.DataBind()

                lblStatus.Text = "New Ocean Rate Update has been uploaded successfully"
            End If
