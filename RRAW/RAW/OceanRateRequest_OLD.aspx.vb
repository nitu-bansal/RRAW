Partial Public Class OceanRateRequest_OLD
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        For Each row As DataRow In DB.UserModulesMapping.GetAccesibleModulesOfUser(CurrentUserID, CurrentClientID).Rows
            If row("Name").ToString.Trim = "oceanraterequestupload" Then
    ...
    Protected Sub btnUploadOcean_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnUpdateOcean.Click
        Try
            ...
            If Page.IsValid Then
                ...
                End If
                DB.Attachments.AddAttachment(DB.Attachments.AttachmentTypes.OceanRateRequestTemplate, 0, txtTitle.Text, filePath)

                txtTitle.Text = ""
                gridUpdates.DataBind()

                lblStatus.Text = "New Ocean Rate Request Template has been uploaded successfully"
            End If
