<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="NewGroundRateRequest.aspx.vb"
    Inherits="RRAW.GroundRateRequest" %>
...
<form id="form1" runat="server">
    ...
    <div class="ui-helper-reset ui-widget-content ui-accordion-content-active ui-icon-bullet">
        <form id="form2">
        </form>
...
<script src="Scripts/GroundRateRequest.js" type="text/javascript"></script>
</html>
