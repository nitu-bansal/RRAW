Public Class Tariff_New
    ...
    Private Sub ApplyFilter()
        ...
        DT_Tariff = DB.Tariffs_New.GetTariffFromDB(1, CurrentClientID, 0)
    ...
    Private Sub gridTariff_DataBound(ByVal sender As Object, ByVal e As System.EventArgs) Handles gridTariff.DataBound
        For i As Integer = 0 To gridTariff.Rows.Count - 1
            gridTariff.Rows(i).ID = gridTariff.Rows(i).Cells(0).Text
            gridTariff.Rows(i).Cells(0).Text = "<img src='images/expand.png' width='30' height='30' style='padding-right:20px;'></img> <a style='vertical-align:middle;' href='newAirRateRequest.aspx?RateRequestID=" & gridTariff.Rows(i).Cells(0).Text & "&TransPortModeId=3&rand=" & (New Random).Next(9999) & "'>" & gridTariff.Rows(i).Cells(0).Text & "</a>"
